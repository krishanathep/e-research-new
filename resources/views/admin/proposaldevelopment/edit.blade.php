...
@section('content')
    <div class="container">
        <h1 class="text-black-50">Edit Proposal Development</h1>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">Edit Proposal Development</div>
                    <div class="card-body container">
                        <form action="">
                            ...
                            <div class="form-group float-right">
                                <a href="{{ route('admin-proposaldevelopment.index') }}" class='btn btn-secondary'><i class="far fa-arrow-alt-circle-left"></i> Go Back</a>
