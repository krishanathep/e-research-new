        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="float-left">
                    <h1 class="text-black-50">Research Type</h1>
                </div>
                <div class="float-right">
                    <a class="btn btn-success mt-2" href="{{ route('admin-general-research.create') }}"> <i class="fas fa-plus"></i> Create </a>
                </div>
            </div>
            <div class="col-lg-12">
                <!-- /.card -->
                            ...
                            <tbody>
                                @foreach ($research as $list)
                                    <tr>
                                        ...
                                        <td>{{ $list->Research_types_detail }}</td>
                                        <td>
